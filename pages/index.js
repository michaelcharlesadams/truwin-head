...
const revealTip = (e) => {
      let tip = document.querySelector("#comingSoon");
      tip.style.visibility = "visible";
      tip.style.transitionDuration = "2s";
...
const hideTip = (e) => {
  let tipOut = document.querySelector("#comingSoon");
  tipOut.style.visibility = "invisible";
  tipOut.style.transitionDuration = "2s";
}
