            ...
            <div id="hero-company-wrapper" className="mx-5 mt-3 md:flex md:min-h-[375px] md:max-h-[400px]">
                <div className="bg-truwinblue-900 rounded text-left px-10 py-8 md:w-5/12 md:h-auto">
                    ...
                    <span className='pr-2'>
                     ...
                     / Company</p>
                    <h3 className="text-white text-3xl sm:text-4xl font-[Cigars-SemiBold] mt-6">We’re changing the  experience of buying windows, doors, and siding.</h3>
    ...
    <div id="onethird-info-section" className="lg:max-w-6xl mx-auto hidden md:block my-28 ">
        <div id="onethird-info-wrapper" className="mx-5 mt-10">
            <div className="text-center" >
                <p className="text-lg text-truwinblue-300 pb-4">We’re built to serve you.</p>
